...
public abstract class Item implements Comparable<Item>, Serializable
{
	...
	private static class PowerHerb extends Item implements HoldItem
	{
		...
		public PowerHerb()
		{
			super(Namesies.POWER_HERB_ITEM, "A single-use item to be held by a Pok̩mon. It allows the immediate use of a move that charges on the first turn.", BagCategory.MISC, 303);
			super.price = 100;
		}
