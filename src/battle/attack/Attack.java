...
import battle.effect.EffectInterfaces.AdvantageMultiplierMove;
...
import battle.effect.EffectInterfaces.CrashDamageMove;
...
import battle.effect.EffectInterfaces.EffectChanceMultiplierEffect;
...
import battle.effect.EffectInterfaces.PowerCountMove;
import battle.effect.EffectInterfaces.RapidSpinRelease;
import battle.effect.EffectInterfaces.RecoilMove;
import battle.effect.EffectInterfaces.RecoilPercentageMove;
import battle.effect.EffectInterfaces.SapHealthEffect;
import battle.effect.EffectInterfaces.SelfAttackBlocker;
import battle.effect.EffectInterfaces.SelfHealingMove;
...
public abstract class Attack implements AttackInterface, InvokeEffect, Serializable {
    ...
    static class LeechSeed extends Attack {
        ...
        LeechSeed() {
            ...
            super.accuracy = 90;
            super.effects.add(PokemonEffectNamesies.LEECH_SEED);
        }
    }
    ...
    static class FireSpin extends Attack {
        ...
        FireSpin() {
            ...
            super.power = 35;
            super.accuracy = 85;
            super.effects.add(PokemonEffectNamesies.FIRE_SPIN);
        }
    }
    ...
    static class Reflect extends Attack {
        ...
        Reflect() {
            ...
            super.effects.add(TeamEffectNamesies.REFLECT);
            super.selfTarget = true;
        }
    }
    ...
    static class AuroraVeil extends Attack {
        ...
        AuroraVeil() {
            ...
            super.effects.add(TeamEffectNamesies.AURORA_VEIL);
            super.selfTarget = true;
        }
    ...
    static class SpikyShield extends Attack {
        ...
        SpikyShield() {
            ...
            super.effects.add(PokemonEffectNamesies.SPIKY_SHIELD);
    ...
    static class BanefulBunker extends Attack {
        ...
        BanefulBunker() {
            ...
            super.effects.add(PokemonEffectNamesies.BANEFUL_BUNKER);
            super.moveTypes.add(MoveType.SUCCESSIVE_DECAY);
            super.moveTypes.add(MoveType.ASSISTLESS);
            super.moveTypes.add(MoveType.METRONOMELESS);
            super.moveTypes.add(MoveType.NON_SNATCHABLE);
    ...
    static class KingsShield extends Attack {
        ...
        KingsShield() {
            ...
            super.effects.add(PokemonEffectNamesies.KINGS_SHIELD);
            super.moveTypes.add(MoveType.SUCCESSIVE_DECAY);
            super.moveTypes.add(MoveType.ASSISTLESS);
            super.moveTypes.add(MoveType.METRONOMELESS);
            super.moveTypes.add(MoveType.NON_SNATCHABLE);
    ...
    static class Protect extends Attack {
        ...
        Protect() {
            ...
            super.effects.add(PokemonEffectNamesies.PROTECTING);
            super.moveTypes.add(MoveType.SUCCESSIVE_DECAY);
            super.moveTypes.add(MoveType.ASSISTLESS);
            super.moveTypes.add(MoveType.METRONOMELESS);
            super.moveTypes.add(MoveType.NON_SNATCHABLE);
    ...
    static class QuickGuard extends Attack {
        ...
        QuickGuard() {
            ...
            super.effects.add(PokemonEffectNamesies.QUICK_GUARD);
            super.moveTypes.add(MoveType.SUCCESSIVE_DECAY);
            super.moveTypes.add(MoveType.ASSISTLESS);
            super.moveTypes.add(MoveType.METRONOMELESS);
            super.moveTypes.add(MoveType.NON_SNATCHABLE);
    ...
    static class Endure extends Attack {
        ...
        Endure() {
            ...
            super.effects.add(PokemonEffectNamesies.BRACING);
            super.moveTypes.add(MoveType.ASSISTLESS);
            super.moveTypes.add(MoveType.SUCCESSIVE_DECAY);
            super.moveTypes.add(MoveType.NON_SNATCHABLE);
            super.moveTypes.add(MoveType.METRONOMELESS);
    ...
    static class PetalDance extends Attack {
        ...
        PetalDance() {
            ...
            super.power = 120;
            super.accuracy = 100;
            super.effects.add(PokemonEffectNamesies.SELF_CONFUSION);
            super.moveTypes.add(MoveType.DANCE);
            super.moveTypes.add(MoveType.PHYSICAL_CONTACT);
            super.selfTarget = true;
        }
    ...
    static class Tailwind extends Attack {
        ...
        Tailwind() {
            ...
            super.effects.add(TeamEffectNamesies.TAILWIND);
            super.selfTarget = true;
        }
    }
    ...
    static class Encore extends Attack {
        ...
        Encore() {
            ...
            super.accuracy = 100;
            super.effects.add(PokemonEffectNamesies.ENCORE);
            super.moveTypes.add(MoveType.ENCORELESS);
    ...
    static class Disable extends Attack {
        ...
        Disable() {
            ...
            super.accuracy = 100;
            super.effects.add(PokemonEffectNamesies.DISABLE);
            super.moveTypes.add(MoveType.SUBSTITUTE_PIERCING);
        }
    }
    ...
    static class FocusEnergy extends Attack {
        ...
        FocusEnergy() {
            ...
            super.effects.add(PokemonEffectNamesies.RAISE_CRITS);
            super.selfTarget = true;
        }
    }
    ...
    static class Rage extends Attack implements PowerChangeEffect {
        ...
        Rage() {
            ...
            super.power = 20;
            super.accuracy = 100;
            super.effects.add(PokemonEffectNamesies.RAGING);
            super.moveTypes.add(MoveType.PHYSICAL_CONTACT);
            super.selfTarget = true;
        }
    ...
    static class ToxicSpikes extends Attack {
        ...
        ToxicSpikes() {
            ...
            super.effects.add(TeamEffectNamesies.TOXIC_SPIKES);
            super.moveTypes.add(MoveType.FIELD);
        }
    }
    ...
    static class Wrap extends Attack {
        ...
        Wrap() {
            ...
            super.power = 15;
            super.accuracy = 90;
            super.effects.add(PokemonEffectNamesies.WRAPPED);
            super.moveTypes.add(MoveType.PHYSICAL_CONTACT);
        }
    }
    ...
    static class Stockpile extends Attack {
        ...
        Stockpile() {
            ...
            super.effects.add(PokemonEffectNamesies.STOCKPILE);
            super.selfTarget = true;
        }
    }
    ...
    static class LightScreen extends Attack {
        ...
        LightScreen() {
            ...
            super.effects.add(TeamEffectNamesies.LIGHT_SCREEN);
            super.selfTarget = true;
        }
    }
    ...
    static class DefenseCurl extends Attack {
        ...
        DefenseCurl() {
            ...
            super.effects.add(PokemonEffectNamesies.USED_DEFENSE_CURL);
            super.selfTarget = true;
            super.statChanges[Stat.DEFENSE.index()] = 1;
        }
    }
    ...
    static class SandTomb extends Attack {
        ...
        SandTomb() {
            ...
            super.power = 35;
            super.accuracy = 85;
            super.effects.add(PokemonEffectNamesies.SAND_TOMB);
        }
    }
    ...
    static class Wish extends Attack {
        ...
        Wish() {
            ...
            super.effects.add(TeamEffectNamesies.WISH);
            super.moveTypes.add(MoveType.HEALING);
            super.selfTarget = true;
        }
    }
    ...
    static class Minimize extends Attack {
        ...
        Minimize() {
            ...
            super.effects.add(PokemonEffectNamesies.USED_MINIMIZE);
            super.selfTarget = true;
            super.statChanges[Stat.EVASION.index()] = 2;
        }
    }
    ...
    static class LuckyChant extends Attack {
        ...
        LuckyChant() {
            ...
            super.effects.add(TeamEffectNamesies.LUCKY_CHANT);
            super.selfTarget = true;
        }
    }
    ...
    static class Mimic extends Attack {
        ...
        Mimic() {
            ...
            super.effects.add(PokemonEffectNamesies.MIMIC);
            super.moveTypes.add(MoveType.ENCORELESS);
            super.moveTypes.add(MoveType.ASSISTLESS);
            super.moveTypes.add(MoveType.METRONOMELESS);
            super.moveTypes.add(MoveType.NON_SNATCHABLE);
    ...
    static class Imprison extends Attack {
        ...
        Imprison() {
            ...
            super.effects.add(PokemonEffectNamesies.IMPRISON);
            super.moveTypes.add(MoveType.PROTECT_PIERCING);
            super.moveTypes.add(MoveType.SUBSTITUTE_PIERCING);
        }
    }
    ...
    static class MeanLook extends Attack {
        ...
        MeanLook() {
            ...
            super.effects.add(PokemonEffectNamesies.TRAPPED);
        }
    }
    ...
    static class Foresight extends Attack {
        ...
        Foresight() {
            ...
            super.effects.add(PokemonEffectNamesies.FORESIGHT);
            super.moveTypes.add(MoveType.SUBSTITUTE_PIERCING);
        }
    ...
    static class MiracleEye extends Attack {
        ...
        MiracleEye() {
            ...
            super.effects.add(PokemonEffectNamesies.MIRACLE_EYE);
            super.moveTypes.add(MoveType.SUBSTITUTE_PIERCING);
        }
    ...
    static class Taunt extends Attack {
        ...
        Taunt() {
            ...
            super.accuracy = 100;
            super.effects.add(PokemonEffectNamesies.TAUNT);
            super.moveTypes.add(MoveType.SUBSTITUTE_PIERCING);
        }
    }
    ...
    static class PayDay extends Attack {
        ...
        PayDay() {
            ...
            super.power = 40;
            super.accuracy = 100;
            super.effects.add(TeamEffectNamesies.PAY_DAY);
            super.selfTarget = true;
        }
    }
    ...
    static class MindReader extends Attack {
        ...
        MindReader() {
            ...
            super.effects.add(PokemonEffectNamesies.LOCK_ON);
            super.moveTypes.add(MoveType.NON_SNATCHABLE);
            super.selfTarget = true;
        }
    }
    ...
    static class Telekinesis extends Attack {
        ...
        Telekinesis() {
            ...
            super.effects.add(PokemonEffectNamesies.TELEKINESIS);
            super.moveTypes.add(MoveType.AIRBORNE);
        }
    }
    ...
    static class Ingrain extends Attack {
        ...
        Ingrain() {
            ...
            super.effects.add(PokemonEffectNamesies.INGRAIN);
            super.selfTarget = true;
        }
    }
    ...
    static class FutureSight extends Attack {
        ...
        FutureSight() {
            ...
            super.power = 120;
            super.accuracy = 100;
            super.effects.add(TeamEffectNamesies.FUTURE_SIGHT);
            super.moveTypes.add(MoveType.PROTECT_PIERCING);
            super.moveTypes.add(MoveType.MIRRORLESS);
        }
    ...
    static class DoomDesire extends Attack {
        ...
        DoomDesire() {
            ...
            super.power = 140;
            super.accuracy = 100;
            super.effects.add(TeamEffectNamesies.DOOM_DESIRE);
            super.moveTypes.add(MoveType.PROTECT_PIERCING);
            super.moveTypes.add(MoveType.MIRRORLESS);
        }
    ...
    static class SmackDown extends Attack implements SemiInvulnerableBypasser, PowerChangeEffect {
        ...
        SmackDown() {
            ...
            super.power = 50;
            super.accuracy = 100;
            super.effects.add(PokemonEffectNamesies.GROUNDED);
        }
    ...
    static class StealthRock extends Attack {
        ...
        StealthRock() {
            ...
            super.effects.add(TeamEffectNamesies.STEALTH_ROCK);
            super.moveTypes.add(MoveType.FIELD);
        }
    }
    ...
    static class Curse extends Attack {
        ...
        public void beginAttack(Battle b, ActivePokemon attacking, ActivePokemon defending) {
            ...
            if (attacking.isType(b, Type.GHOST)) {
                super.effects.add(PokemonEffectNamesies.CURSE);
    ...
    static class Yawn extends Attack {
        ...
        Yawn() {
            ...
            super.effects.add(PokemonEffectNamesies.YAWN);
        }
    }
    ...
    static class MagnetRise extends Attack {
        ...
        MagnetRise() {
            ...
            super.effects.add(PokemonEffectNamesies.MAGNET_RISE);
            super.moveTypes.add(MoveType.AIRBORNE);
            super.selfTarget = true;
        }
    }
    ...
    static class Uproar extends Attack {
        ...
        Uproar() {
            ...
            super.power = 90;
            super.accuracy = 100;
            super.effects.add(PokemonEffectNamesies.UPROAR);
            super.moveTypes.add(MoveType.SOUND_BASED);
            super.moveTypes.add(MoveType.SLEEP_TALK_FAIL);
            super.selfTarget = true;
        }
    ...
    static class AquaRing extends Attack {
        ...
        AquaRing() {
            ...
            super.effects.add(PokemonEffectNamesies.AQUA_RING);
            super.selfTarget = true;
        }
    }
    ...
    static class Clamp extends Attack {
        ...
        Clamp() {
            ...
            super.power = 35;
            super.accuracy = 85;
            super.effects.add(PokemonEffectNamesies.CLAMPED);
            super.moveTypes.add(MoveType.PHYSICAL_CONTACT);
        }
    }
    ...
    static class Whirlpool extends Attack {
        ...
        Whirlpool() {
            ...
            super.power = 35;
            super.accuracy = 85;
            super.effects.add(PokemonEffectNamesies.WHIRLPOOLED);
        }
    }
    ...
    static class Spikes extends Attack {
        ...
        Spikes() {
            ...
            super.effects.add(TeamEffectNamesies.SPIKES);
            super.moveTypes.add(MoveType.FIELD);
        }
    }
    ...
    static class Nightmare extends Attack {
        ...
        Nightmare() {
            ...
            super.accuracy = 100;
            super.effects.add(PokemonEffectNamesies.NIGHTMARE);
            super.moveTypes.add(MoveType.NO_MAGIC_COAT);
        }
    }
    ...
    static class Bind extends Attack {
        ...
        Bind() {
            ...
            super.power = 15;
            super.accuracy = 85;
            super.effects.add(PokemonEffectNamesies.BINDED);
            super.moveTypes.add(MoveType.PHYSICAL_CONTACT);
        }
    }
    ...
    static class Charge extends Attack {
        ...
        Charge() {
            ...
            super.effects.add(PokemonEffectNamesies.CHARGE);
            super.selfTarget = true;
            super.statChanges[Stat.SP_DEFENSE.index()] = 1;
        }
    }
    ...
    static class FocusPunch extends Attack {
        ...
        FocusPunch() {
            ...
            super.power = 150;
            super.accuracy = 100;
            super.effects.add(PokemonEffectNamesies.FOCUSING);
            super.moveTypes.add(MoveType.PUNCHING);
            super.moveTypes.add(MoveType.ASSISTLESS);
            super.moveTypes.add(MoveType.SLEEP_TALK_FAIL);
            super.moveTypes.add(MoveType.METRONOMELESS);
    ...
    static class ShellTrap extends Attack {
        ...
        ShellTrap() {
            ...
            super.power = 150;
            super.accuracy = 100;
            super.effects.add(PokemonEffectNamesies.SHELL_TRAP);
            super.moveTypes.add(MoveType.ASSISTLESS);
            super.moveTypes.add(MoveType.SLEEP_TALK_FAIL);
            super.moveTypes.add(MoveType.METRONOMELESS);
            super.moveTypes.add(MoveType.MIRRORLESS);
    ...
    static class BeakBlast extends Attack {
        ...
        BeakBlast() {
            ...
            super.power = 100;
            super.accuracy = 100;
            super.effects.add(PokemonEffectNamesies.BEAK_BLAST);
            super.moveTypes.add(MoveType.ASSISTLESS);
            super.moveTypes.add(MoveType.SLEEP_TALK_FAIL);
            super.moveTypes.add(MoveType.METRONOMELESS);
            super.moveTypes.add(MoveType.MIRRORLESS);
    ...
    static class Transform extends Attack {
        ...
        Transform() {
            ...
            super.effects.add(PokemonEffectNamesies.TRANSFORMED);
            super.moveTypes.add(MoveType.NON_SNATCHABLE);
            super.moveTypes.add(MoveType.ENCORELESS);
            super.moveTypes.add(MoveType.ASSISTLESS);
            super.moveTypes.add(MoveType.METRONOMELESS);
    ...
    static class Substitute extends Attack {
        ...
        Substitute() {
            ...
            super.effects.add(PokemonEffectNamesies.SUBSTITUTE);
            super.selfTarget = true;
        }
    }
    ...
    static class Mist extends Attack {
        ...
        Mist() {
            ...
            super.effects.add(PokemonEffectNamesies.MIST);
            super.selfTarget = true;
        }
    }
    ...
    static class MagicCoat extends Attack {
        ...
        MagicCoat() {
            ...
            super.effects.add(PokemonEffectNamesies.MAGIC_COAT);
            super.moveTypes.add(MoveType.NON_SNATCHABLE);
            super.selfTarget = true;
            super.priority = 4;
        }
    ...
    static class Torment extends Attack {
        ...
        Torment() {
            ...
            super.accuracy = 100;
            super.effects.add(PokemonEffectNamesies.TORMENT);
            super.moveTypes.add(MoveType.SUBSTITUTE_PIERCING);
        }
    }
    ...
    static class Bide extends Attack {
        ...
        Bide() {
            ...
            super.effects.add(PokemonEffectNamesies.BIDE);
            super.moveTypes.add(MoveType.SLEEP_TALK_FAIL);
            super.moveTypes.add(MoveType.MIRRORLESS);
            super.moveTypes.add(MoveType.PHYSICAL_CONTACT);
            super.selfTarget = true;
    ...
    static class Autotomize extends Attack {
        ...
        Autotomize() {
            ...
            super.effects.add(PokemonEffectNamesies.HALF_WEIGHT);
            super.selfTarget = true;
            super.statChanges[Stat.SPEED.index()] = 2;
        }
    }
    ...
    static class PowerTrick extends Attack {
        ...
        PowerTrick() {
            ...
            super.effects.add(PokemonEffectNamesies.POWER_TRICK);
            super.selfTarget = true;
        }
    }
    ...
    static class PowerSplit extends Attack {
        ...
        PowerSplit() {
            ...
            super.effects.add(PokemonEffectNamesies.POWER_SPLIT);
            super.moveTypes.add(MoveType.NON_SNATCHABLE);
            super.selfTarget = true;
        }
    }
    ...
    static class GuardSplit extends Attack {
        ...
        GuardSplit() {
            ...
            super.effects.add(PokemonEffectNamesies.GUARD_SPLIT);
            super.moveTypes.add(MoveType.NON_SNATCHABLE);
            super.selfTarget = true;
        }
    }
    ...
    static class HealBlock extends Attack {
        ...
        HealBlock() {
            ...
            super.accuracy = 100;
            super.effects.add(PokemonEffectNamesies.HEAL_BLOCK);
        }
    }
    ...
    static class Snatch extends Attack {
        ...
        Snatch() {
            ...
            super.effects.add(PokemonEffectNamesies.SNATCH);
            super.moveTypes.add(MoveType.ASSISTLESS);
            super.moveTypes.add(MoveType.METRONOMELESS);
            super.moveTypes.add(MoveType.NON_SNATCHABLE);
            super.selfTarget = true;
    ...
    static class MagmaStorm extends Attack {
        ...
        MagmaStorm() {
            ...
            super.power = 100;
            super.accuracy = 75;
            super.effects.add(PokemonEffectNamesies.MAGMA_STORM);
        }
    }
    ...
    static class GastroAcid extends Attack implements AbilityChanger {
        ...
        GastroAcid() {
            ...
            super.accuracy = 100;
            super.effects.add(PokemonEffectNamesies.CHANGE_ABILITY);
        }
    ...
    static class HealingWish extends Attack {
        ...
        HealingWish() {
            ...
            super.effects.add(TeamEffectNamesies.HEAL_SWITCH);
            super.moveTypes.add(MoveType.USER_FAINTS);
            super.moveTypes.add(MoveType.HEALING);
            super.selfTarget = true;
        }
    ...
    static class Grudge extends Attack {
        ...
        Grudge() {
            ...
            super.effects.add(PokemonEffectNamesies.GRUDGE);
            super.moveTypes.add(MoveType.SUBSTITUTE_PIERCING);
            super.moveTypes.add(MoveType.NON_SNATCHABLE);
            super.selfTarget = true;
        }
    ...
    static class DestinyBond extends Attack {
        ...
        DestinyBond() {
            ...
            super.effects.add(PokemonEffectNamesies.DESTINY_BOND);
            super.moveTypes.add(MoveType.SUBSTITUTE_PIERCING);
            super.moveTypes.add(MoveType.ASSISTLESS);
            super.moveTypes.add(MoveType.METRONOMELESS);
            super.moveTypes.add(MoveType.NON_SNATCHABLE);
    ...
    static class Embargo extends Attack {
        ...
        Embargo() {
            ...
            super.accuracy = 100;
            super.effects.add(PokemonEffectNamesies.EMBARGO);
        }
    }
    ...
    static class CraftyShield extends Attack {
        ...
        CraftyShield() {
            ...
            super.effects.add(PokemonEffectNamesies.CRAFTY_SHIELD);
            super.moveTypes.add(MoveType.SUCCESSIVE_DECAY);
            super.moveTypes.add(MoveType.ASSISTLESS);
            super.moveTypes.add(MoveType.METRONOMELESS);
            super.moveTypes.add(MoveType.NON_SNATCHABLE);
    ...
    static class FairyLock extends Attack {
        ...
        FairyLock() {
            ...
            super.effects.add(PokemonEffectNamesies.FAIRY_LOCK);
            super.moveTypes.add(MoveType.NON_SNATCHABLE);
            super.selfTarget = true;
        }
    }
    ...
    static class Powder extends Attack implements PowderMove {
        ...
        Powder() {
            ...
            super.accuracy = 100;
            super.effects.add(PokemonEffectNamesies.POWDER);
            super.priority = 1;
        }
    }
    ...
    static class MatBlock extends Attack {
        ...
        MatBlock() {
            ...
            super.effects.add(PokemonEffectNamesies.MAT_BLOCK);
            super.moveTypes.add(MoveType.ASSISTLESS);
            super.selfTarget = true;
        }
    ...
    static class Infestation extends Attack {
        ...
        Infestation() {
            ...
            super.power = 20;
            super.accuracy = 100;
            super.effects.add(PokemonEffectNamesies.INFESTATION);
            super.moveTypes.add(MoveType.PHYSICAL_CONTACT);
        }
    }
    ...
    static class Electrify extends Attack implements ChangeAttackTypeSource {
        ...
        Electrify() {
            ...
            super.effects.add(PokemonEffectNamesies.CHANGE_ATTACK_TYPE);
            super.moveTypes.add(MoveType.NO_MAGIC_COAT);
            super.priority = 1;
        }
    ...
    static class StickyWeb extends Attack {
        ...
        StickyWeb() {
            ...
            super.effects.add(TeamEffectNamesies.STICKY_WEB);
            super.moveTypes.add(MoveType.FIELD);
        }
    }
    ...
    static class LaserFocus extends Attack {
        ...
        LaserFocus() {
            ...
            super.effects.add(PokemonEffectNamesies.LASER_FOCUS);
            super.selfTarget = true;
        }
    }
