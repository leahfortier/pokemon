...
public class ItemTest extends BaseTest {
    ...
    private void swapItemsTest(boolean isTrainerBattle) {
        ...
        battle.emptyHeal();
        attacking.assertHoldingItem(battle, ItemNamesies.WATER_STONE);
        ...
        defending.assertHoldingItem(battle, ItemNamesies.WATER_STONE);
    ...
    private void stickyBarbTest(boolean isTrainerBattle) {
        ...
        attacking.assertHoldingItem(battle, ItemNamesies.WATER_STONE);
        defending.assertHoldingItem(battle, ItemNamesies.STICKY_BARB);

        // Switcheroo -- swap items
        battle.attackingFight(AttackNamesies.SWITCHEROO);
        attacking.assertHoldingItem(battle, ItemNamesies.STICKY_BARB);
        defending.assertHoldingItem(battle, ItemNamesies.WATER_STONE);
